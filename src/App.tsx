  ...
  return (
    <div className="bg-onyx text-white font-sans min-h-screen selection:bg-gold-accent selection:text-black overflow-hidden">
      ...
      <nav ref={navRef} className="fixed top-0 w-full px-6 md:px-16 py-6 flex justify-between items-center z-50 backdrop-blur-2xl bg-onyx/80 border-b border-white/10 shadow-[0_4px_30px_rgba(0,0,0,0.5)] opacity-0">
        ...
        {/* Mobile Menu Overlay */}
        <div className={`fixed inset-0 bg-onyx/60 backdrop-blur-3xl z-[90] transition-all duration-500 flex flex-col justify-center items-center gap-8 ${isMenuOpen ? 'opacity-100 visible' : 'opacity-0 invisible pointer-events-none'}`}>
          {/* Menu Branding */}
          ...
          {['ABOUT', 'PROCESS', 'PORTFOLIO', 'CONTACT'].map((item) => (
            <a
              ...
              className="text-4xl font-extrabold tracking-[2px] text-white/70 hover:text-white transition-all duration-300 hover:scale-105"
      ...
      <main className={`relative z-10 transition-opacity duration-300 ${isMenuOpen ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}>
        <div className="container mx-auto px-6 md:px-12 max-w-7xl relative">
          ...
          <section className="pt-48 pb-20 relative" ref={heroRef}>
            ...
            <h1 className="text-6xl md:text-9xl font-extrabold tracking-tighter leading-tight drop-shadow-2xl relative z-20 mb-12">
                ...
                <div key={i} className="flex gap-4">
                  {[
                    ...
                    <div
                      ...
                      className="flex items-center gap-[15px] py-[20px] px-[30px] bg-[#0f0f0f] rounded-[15px] whitespace-nowrap shadow-[inset_0px_1px_20px_0px_rgba(255,255,255,0.07)] border border-white/5 transition-colors duration-300 hover:border-white/10 group cursor-default"
                    >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="text-gray-400 leading-relaxed mb-6 text-lg">
                  Onyx & Code is not just a development agency; we are architects of the virtual frontier.
                </p>
              ...
              <div className="relative h-full min-h-[400px]">
                ...
                <div className="absolute inset-0 rounded-2xl border border-white/20 bg-white/5 backdrop-blur-2xl shadow-[0_8px_32px_0_rgba(0,0,0,0.36)] flex items-center justify-center overflow-hidden group hover:border-gold-accent/40 transition-all duration-700">
                ...
                <div className="relative">
                  <div className="grid grid-cols-4 gap-4 mask-image-gradient relative z-20">
                    {[
                      ...
                      <div
                        key={tool.name}
                        className="aspect-square bg-white/5 rounded-xl border border-white/10 flex items-center justify-center text-3xl group relative transition-all duration-500 hover:border-white/30 hover:bg-white/10"
                        title={tool.name}
                      >
          ...
          <section id="pricing" className="py-32">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto">
              {/* Card 1: Landing Page */}
              <div className="group relative bg-onyx-light border border-white/10 p-10 rounded-2xl overflow-hidden hover:border-gold-accent/50 transition-all duration-500 hover:shadow-[0_0_50px_rgba(212,175,55,0.1)]">
                ...
                <h3 className="text-3xl font-bold mb-4 text-white">Landing Page</h3>
                <p className="text-gray-400 mb-6">A high-converting landing page designed to drive results.</p>
                ...
                <ul className="space-y-4 mb-10 text-sm text-gray-300">
                  <li className="flex items-center gap-3"><span className="text-gold-accent">✓</span> Unlimited requests</li>
                  <li className="flex items-center gap-3"><span className="text-gold-accent">✓</span> Figma file</li>
                  <li className="flex items-center gap-3"><span className="text-gold-accent">✓</span> Mobile responsive</li>
                  <li className="flex items-center gap-3"><span className="text-gold-accent">✓</span> 5 days delivery</li>
                </ul>

                <button
                  onClick={() => document.getElementById('contact')?.scrollIntoView({ behavior: 'smooth' })}
                  className="w-full py-4 border border-white/20 rounded-lg hover:bg-white hover:text-black font-bold tracking-widest uppercase transition-all"
                >
                  Request a quote
                </button>
              </div>
              ...
              <div className="group relative bg-onyx-light border border-white/10 p-10 rounded-2xl overflow-hidden hover:border-gold-accent/50 transition-all duration-500 hover:shadow-[0_0_50px_rgba(212,175,55,0.1)]">
                ...
                <h3 className="text-3xl font-bold mb-4 text-white">Multi-page Website</h3>
                <p className="text-gray-400 mb-6">Fully integrated digital ecosystem designed for scale.</p>
                ...
                <ul className="space-y-4 mb-10 text-sm text-gray-300">
                  <li className="flex items-center gap-3"><span className="text-gold-accent">✓</span> CMS Integration</li>
                  <li className="flex items-center gap-3"><span className="text-gold-accent">✓</span> Advanced SEO Setup</li>
                  <li className="flex items-center gap-3"><span className="text-gold-accent">✓</span> Dynamic Animations</li>
                  <li className="flex items-center gap-3"><span className="text-gold-accent">✓</span> 2 Weeks Delivery</li>
                </ul>
              ...
              <div className="group relative bg-[#0a0a0a] border border-white/10 p-10 rounded-2xl overflow-hidden hover:border-white/20 transition-all duration-500 flex flex-col justify-center">
                ...
                <button
                  onClick={() => document.getElementById('contact')?.scrollIntoView({ behavior: 'smooth' })}
                  className="w-full py-4 bg-white/5 border border-white/10 text-white font-bold tracking-widest uppercase rounded-lg hover:bg-white hover:text-black transition-all"
                >
                  Contact sales
                </button>
              </div>
