...
export default function AgentChat() {
    ...
    return (
        <div className="fixed bottom-8 right-8 z-[100] flex flex-col items-end gap-4">
                ...
                <div className="flex flex-col h-[400px] w-full">
                    ...
                    <form onSubmit={handleSend} className="p-4 border-t border-white/10 bg-black/30">
                        <div className="flex gap-2">
                            ...
                            />
                            <button type="submit" className="text-gold-accent hover:text-white transition-colors">
            ...
            <button
                onClick={toggleChat}
                className="group relative w-14 h-14 rounded-full bg-onyx border border-white/20 shadow-lg hover:border-gold-accent transition-all duration-300 flex items-center justify-center overflow-hidden"
            >
