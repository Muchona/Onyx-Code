        ...
        <div className="min-h-screen w-full bg-onyx text-white font-sans flex items-center justify-center p-6 relative overflow-hidden">
          ...
          // TRANSMISSION_COMPLETE
                ...
                <Link to="/" className="group relative w-full md:w-auto block">
                    ...
                    <div className="relative bg-black border border-white/10 rounded-xl px-10 py-4 font-bold uppercase tracking-widest text-sm hover:bg-onyx-light transition-colors group-hover:text-gold-accent">
